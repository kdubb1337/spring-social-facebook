...
public class EventTemplateTest extends AbstractFacebookApiTest {
	...
	public void getCreated_user() {
		mockServer.expect(requestTo(GraphApi.GRAPH_API_URL + "me/events/created?offset=0&limit=25"))
	...
	public void getCreated_friend() {
		mockServer.expect(requestTo(GraphApi.GRAPH_API_URL + "123456789/events/created?offset=0&limit=25"))
			.andExpect(method(GET))
			.andExpect(header("Authorization", "OAuth someAccessToken"))
			.andRespond(withSuccess(jsonResource("user-events"), MediaType.APPLICATION_JSON));
	...
	public void getAttending_user() {
		mockServer.expect(requestTo(GraphApi.GRAPH_API_URL + "me/events/attending?offset=0&limit=25"))
			.andExpect(method(GET))
			.andExpect(header("Authorization", "OAuth someAccessToken"))
			.andRespond(withSuccess(jsonResource("user-events"), MediaType.APPLICATION_JSON));
	...
	public void getAttending_friend() {
		mockServer.expect(requestTo(GraphApi.GRAPH_API_URL + "123456789/events/attending?offset=0&limit=25"))
			.andExpect(method(GET))
			.andExpect(header("Authorization", "OAuth someAccessToken"))
			.andRespond(withSuccess(jsonResource("user-events"), MediaType.APPLICATION_JSON));
	...
	public void getMaybe_user() {
		mockServer.expect(requestTo(GraphApi.GRAPH_API_URL + "me/events/maybe?offset=0&limit=25"))
			.andExpect(method(GET))
			.andExpect(header("Authorization", "OAuth someAccessToken"))
			.andRespond(withSuccess(jsonResource("user-events"), MediaType.APPLICATION_JSON));
	...
	public void getMaybe_friend() {
		mockServer.expect(requestTo(GraphApi.GRAPH_API_URL + "123456789/events/maybe?offset=0&limit=25"))
			.andExpect(method(GET))
			.andExpect(header("Authorization", "OAuth someAccessToken"))
			.andRespond(withSuccess(jsonResource("user-events"), MediaType.APPLICATION_JSON));
	...
	public void getNoReplies_user() {
		mockServer.expect(requestTo(GraphApi.GRAPH_API_URL + "me/events/not_replied?offset=0&limit=25"))
			.andExpect(method(GET))
			.andExpect(header("Authorization", "OAuth someAccessToken"))
			.andRespond(withSuccess(jsonResource("user-events"), MediaType.APPLICATION_JSON));
	...
	public void getNoReplies_friend() {
		mockServer.expect(requestTo(GraphApi.GRAPH_API_URL + "123456789/events/not_replied?offset=0&limit=25"))
			.andExpect(method(GET))
			.andExpect(header("Authorization", "OAuth someAccessToken"))
			.andRespond(withSuccess(jsonResource("user-events"), MediaType.APPLICATION_JSON));
	...
	public void getDeclined_user() {
		mockServer.expect(requestTo(GraphApi.GRAPH_API_URL + "me/events/declined?offset=0&limit=25"))
			.andExpect(method(GET))
			.andExpect(header("Authorization", "OAuth someAccessToken"))
			.andRespond(withSuccess(jsonResource("user-events"), MediaType.APPLICATION_JSON));
	...
	public void getDeclined_friend() {
		mockServer.expect(requestTo(GraphApi.GRAPH_API_URL + "123456789/events/declined?offset=0&limit=25"))
			.andExpect(method(GET))
			.andExpect(header("Authorization", "OAuth someAccessToken"))
			.andRespond(withSuccess(jsonResource("user-events"), MediaType.APPLICATION_JSON));
	...
	public void getEvent() {
		mockServer.expect(requestTo(GraphApi.GRAPH_API_URL + "193482154020832?fields=id%2Ccover%2Cdescription%2Cend_time%2Cis_date_only%2Clocation%2Cname"
	...
	public void getInvited() {
		mockServer.expect(requestTo(GraphApi.GRAPH_API_URL + "193482154020832/invited"))
			.andExpect(method(GET))
			.andExpect(header("Authorization", "OAuth someAccessToken"))
	...
	public void getAttending() {
		mockServer.expect(requestTo(GraphApi.GRAPH_API_URL + "193482154020832/attending"))
			.andExpect(method(GET))
			.andExpect(header("Authorization", "OAuth someAccessToken"))
	...
	public void getMaybeAttending() {
		mockServer.expect(requestTo(GraphApi.GRAPH_API_URL + "193482154020832/maybe"))
			.andExpect(method(GET))
			.andExpect(header("Authorization", "OAuth someAccessToken"))
	...
	public void getNoReplies() {
		mockServer.expect(requestTo(GraphApi.GRAPH_API_URL + "193482154020832/noreply"))
			.andExpect(method(GET))
			.andExpect(header("Authorization", "OAuth someAccessToken"))
	...
	public void getDeclined() {
		mockServer.expect(requestTo(GraphApi.GRAPH_API_URL + "193482154020832/declined"))
			.andExpect(method(GET))
			.andExpect(header("Authorization", "OAuth someAccessToken"))
	...
	@Test
	public void search() {
		mockServer.expect(requestTo(GraphApi.GRAPH_API_URL + "search?offset=0&limit=25&q=Spring+User+Group&type=event"))
			.andExpect(method(GET))
			.andExpect(header("Authorization", "OAuth someAccessToken"))
