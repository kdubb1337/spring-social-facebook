...
public class BookActionsTemplateTest extends AbstractFacebookApiTest {
	...
	public void readBook() throws Exception {
		mockServer.expect(requestTo(GraphApi.GRAPH_API_URL + "me/book.reads"))
	...
	public void quoteBook() throws Exception {
		mockServer.expect(requestTo(GraphApi.GRAPH_API_URL + "me/books.quotes"))
			.andExpect(method(POST))
	...
	public void rateBook() throws Exception {
		mockServer.expect(requestTo(GraphApi.GRAPH_API_URL + "me/books.rates"))
			.andExpect(method(POST))
	...
	public void wantsToRead() throws Exception {
		mockServer.expect(requestTo(GraphApi.GRAPH_API_URL + "me/books.wants_to_read"))
			.andExpect(method(POST))
