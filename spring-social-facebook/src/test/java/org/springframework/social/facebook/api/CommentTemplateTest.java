...
public class CommentTemplateTest extends AbstractFacebookApiTest {
	...
	public void getComments() throws Exception {
		mockServer.expect(requestTo(GraphApi.GRAPH_API_URL + "123456/comments?offset=0&limit=25"))
	...
	public void getComments_withOffsetAndLimit() {
		mockServer.expect(requestTo(GraphApi.GRAPH_API_URL + "123456/comments?offset=75&limit=100"))
			.andExpect(method(GET))
			.andExpect(header("Authorization", "OAuth someAccessToken"))
			.andRespond(withSuccess(jsonResource("comments"), MediaType.APPLICATION_JSON));
	...
	public void getComment() {
		mockServer.expect(requestTo(GraphApi.GRAPH_API_URL + "1533260333_122829644452184_587062?fields=id%2Cattachment%2Ccan_comment%2Ccan_remove%2Ccomment_count%2Ccreated_time%2Cfrom%2Clike_count%2Cmessage%2Cparent%2Cuser_likes"))
			.andExpect(method(GET))
			.andExpect(header("Authorization", "OAuth someAccessToken"))
	...
	public void addComment() {
		mockServer.expect(requestTo(GraphApi.GRAPH_API_URL + "123456/comments"))
	...
	public void deleteComment() {
		mockServer.expect(requestTo(GraphApi.GRAPH_API_URL + "1533260333_122829644452184_587062"))
			.andExpect(method(POST))
