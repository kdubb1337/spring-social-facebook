...
public class FeedTemplateTest extends AbstractFacebookApiTest {
	...
	@Test
	public void getFeed() {
		mockServer.expect(requestTo(GraphApi.GRAPH_API_URL + "me/feed?limit=25"))
	...
	public void getFeed_withPagedListParameters_since() {
		mockServer.expect(requestTo(GraphApi.GRAPH_API_URL + "me/feed?limit=25&since=1360384019"))
				.andExpect(method(GET))
				.andExpect(header("Authorization", "OAuth someAccessToken"))
			.andRespond(withSuccess(jsonResource("feed"), MediaType.APPLICATION_JSON));
	...
	public void getFeed_withPagedListParameters_until() {
		mockServer.expect(requestTo(GraphApi.GRAPH_API_URL + "me/feed?limit=25&until=1360384019"))
				.andExpect(method(GET))
				.andExpect(header("Authorization", "OAuth someAccessToken"))
			.andRespond(withSuccess(jsonResource("feed"), MediaType.APPLICATION_JSON));
	...
	public void getFeed_forOwnerId() {
		mockServer.expect(requestTo(GraphApi.GRAPH_API_URL + "12345678/feed?limit=25"))
				.andExpect(method(GET))
				.andExpect(header("Authorization", "OAuth someAccessToken"))
			.andRespond(withSuccess(jsonResource("feed"), MediaType.APPLICATION_JSON));
	...
	public void getHomeFeed() {
		mockServer.expect(requestTo(GraphApi.GRAPH_API_URL + "me/home?limit=25"))
			.andExpect(method(GET))
			.andExpect(header("Authorization", "OAuth someAccessToken"))
			.andRespond(withSuccess(jsonResource("feed"), MediaType.APPLICATION_JSON));
	...
	public void getStatuses() {
		mockServer.expect(requestTo(GraphApi.GRAPH_API_URL + "me/statuses?limit=25"))
			.andExpect(method(GET))
			.andExpect(header("Authorization", "OAuth someAccessToken"))
	...
	public void getStatuses_forSpecificUser() {
		mockServer.expect(requestTo(GraphApi.GRAPH_API_URL + "24680/statuses?limit=25"))
			.andExpect(method(GET))
			.andExpect(header("Authorization", "OAuth someAccessToken"))
			.andRespond(withSuccess(jsonResource("user-statuses"), MediaType.APPLICATION_JSON));
	...
	public void getLinks_preOctober2012() {
		mockServer.expect(requestTo(GraphApi.GRAPH_API_URL + "me/links?limit=25"))
			.andExpect(method(GET))
			.andExpect(header("Authorization", "OAuth someAccessToken"))
	...
	public void getLinks_forSpecificUser() {
		mockServer.expect(requestTo(GraphApi.GRAPH_API_URL + "13579/links?limit=25"))
			.andExpect(method(GET))
			.andExpect(header("Authorization", "OAuth someAccessToken"))
			.andRespond(withSuccess(jsonResource("links"), MediaType.APPLICATION_JSON));
	...
	public void getPosts() {
		mockServer.expect(requestTo(GraphApi.GRAPH_API_URL + "me/posts?limit=25"))
				.andExpect(method(GET))
				.andExpect(header("Authorization", "OAuth someAccessToken"))
			.andRespond(withSuccess(jsonResource("feed"), MediaType.APPLICATION_JSON));
	...
	public void getPosts_forOwnerId() {
		mockServer.expect(requestTo(GraphApi.GRAPH_API_URL + "12345678/posts?limit=25"))
				.andExpect(method(GET))
				.andExpect(header("Authorization", "OAuth someAccessToken"))
			.andRespond(withSuccess(jsonResource("feed"), MediaType.APPLICATION_JSON));
	...
	public void getFeedEntry() {
		mockServer.expect(requestTo(GraphApi.GRAPH_API_URL + "100001387295207_123939024341978"))
			.andExpect(method(GET))
			.andExpect(header("Authorization", "OAuth someAccessToken"))
	...
	public void updateStatus() throws Exception {
		...
		mockServer.expect(requestTo(GraphApi.GRAPH_API_URL + "me/feed"))
	...
	public void post_message() throws Exception {
		String requestBody = "message=Hello+Facebook+World";
		mockServer.expect(requestTo(GraphApi.GRAPH_API_URL + "123456789/feed"))
				.andExpect(method(POST))
				.andExpect(header("Authorization", "OAuth someAccessToken"))
				.andExpect(content().string(requestBody))
				.andRespond(withSuccess("{\"id\":\"123456_78901234\"}", MediaType.APPLICATION_JSON));
	...
	public void post_link() throws Exception {
		...
		mockServer.expect(requestTo(GraphApi.GRAPH_API_URL + "me/feed")).andExpect(method(POST))
				.andExpect(header("Authorization", "OAuth someAccessToken"))
				.andExpect(content().string(requestBody))
				.andRespond(withSuccess("{\"id\":\"123456_78901234\"}", MediaType.APPLICATION_JSON));
...
//	}
	...
	public void post_link_toAnotherFeed() throws Exception {
		String requestBody = "link=someLink&name=some+name&caption=some+caption&description=some+description&message=Hello+Facebook+World";
		mockServer.expect(requestTo(GraphApi.GRAPH_API_URL + "123456789/feed")).andExpect(method(POST))
				.andExpect(header("Authorization", "OAuth someAccessToken"))
				.andExpect(content().string(requestBody))
				.andRespond(withSuccess("{\"id\":\"123456_78901234\"}", MediaType.APPLICATION_JSON));
		FacebookLink link = new FacebookLink("someLink", "some name", "some caption", "some description");
	...
	public void deleteFeedEntry() {
		...
		mockServer.expect(requestTo(GraphApi.GRAPH_API_URL + "123456_78901234"))
				.andExpect(method(POST))
	...
	public void searchPublicFeed() {
		mockServer.expect(requestTo(GraphApi.GRAPH_API_URL + "search?q=Dr%20Seuss&type=post&limit=25"))
			.andExpect(method(GET))
			.andExpect(header("Authorization", "OAuth someAccessToken"))
	...
	public void searchHomeFeed() {
		mockServer.expect(requestTo(GraphApi.GRAPH_API_URL + "me/home?q=Dr+Seuss&limit=25"))
			.andExpect(method(GET))
			.andExpect(header("Authorization", "OAuth someAccessToken"))
			.andRespond(withSuccess(jsonResource("post-list"), MediaType.APPLICATION_JSON));
	...
	public void searchUserFeed_currentUser() {
		mockServer.expect(requestTo(GraphApi.GRAPH_API_URL + "me/feed?q=Football&limit=25"))
			.andExpect(method(GET))
			.andExpect(header("Authorization", "OAuth someAccessToken"))
			.andRespond(withSuccess(jsonResource("feed"), MediaType.APPLICATION_JSON));
	...
	public void searchUserFeed_specificUser() {
		mockServer.expect(requestTo(GraphApi.GRAPH_API_URL + "123456789/feed?q=Football&limit=25"))
			.andExpect(method(GET))
			.andExpect(header("Authorization", "OAuth someAccessToken"))
			.andRespond(withSuccess(jsonResource("feed"), MediaType.APPLICATION_JSON));
	...
	public void getCheckins() {
		mockServer.expect(requestTo(GraphApi.GRAPH_API_URL + "me/posts?offset=0&limit=25&with=location"))
			.andExpect(method(GET))
			.andExpect(header("Authorization", "OAuth someAccessToken"))
	...
	public void getCheckin() {
		mockServer.expect(requestTo(GraphApi.GRAPH_API_URL + "10150431253050580"))
			.andExpect(method(GET))
			.andExpect(header("Authorization", "OAuth someAccessToken"))
