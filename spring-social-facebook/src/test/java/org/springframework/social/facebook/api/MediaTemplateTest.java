...
public class MediaTemplateTest extends AbstractFacebookApiTest {
	...
	public void getAlbums() {
		mockServer.expect(requestTo(GraphApi.GRAPH_API_URL + "me/albums?offset=0&limit=25"))
	...
	public void getAlbums_forSpecificUser() {
		mockServer.expect(requestTo(GraphApi.GRAPH_API_URL + "192837465/albums?offset=0&limit=25"))
			.andExpect(method(GET))
			.andExpect(header("Authorization", "OAuth someAccessToken"))
			.andRespond(withSuccess(jsonResource("albums"), MediaType.APPLICATION_JSON));
	...
	public void getAlbums_forSpecificUser_unauthorized() {
		try {
			unauthorizedMockServer.expect(requestTo(GraphApi.GRAPH_API_URL + "192837465/albums?offset=0&limit=25"))
				.andExpect(method(GET))
				.andRespond(withSuccess(jsonResource("albums"), MediaType.APPLICATION_JSON));
	...
	public void getAlbum() {
		mockServer.expect(requestTo(GraphApi.GRAPH_API_URL + "10151447271460580"))
			.andExpect(method(GET))
			.andExpect(header("Authorization", "OAuth someAccessToken"))
	...
	public void getPhotos() {
		mockServer.expect(requestTo(GraphApi.GRAPH_API_URL + "10151447271460580/photos?offset=0&limit=25"))
			.andExpect(method(GET))
			.andExpect(header("Authorization", "OAuth someAccessToken"))
	...
	public void getPhotos_unauthorized() {
		try {
			unauthorizedMockServer.expect(requestTo(GraphApi.GRAPH_API_URL + "192837465/photos?offset=0&limit=25"))
				.andExpect(method(GET))
				.andRespond(withSuccess(jsonResource("photos"), MediaType.APPLICATION_JSON));
	...
	public void getPhoto() {
		mockServer.expect(requestTo(GraphApi.GRAPH_API_URL + "10150447271355581"))
			.andExpect(method(GET))
			.andExpect(header("Authorization", "OAuth someAccessToken"))
	...
	public void getPhoto_unauthorized() {
		try {
			unauthorizedMockServer.expect(requestTo(GraphApi.GRAPH_API_URL + "10150447271355581"))
				.andExpect(method(GET))
				.andRespond(withSuccess(jsonResource("photo"), MediaType.APPLICATION_JSON));
	...
	public void postPhoto_noCaption() {
		mockServer.expect(requestTo(GraphApi.GRAPH_API_URL + "me/photos"))
	...
	public void postPhoto_ToAlbumNoCaption() {
		mockServer.expect(requestTo(GraphApi.GRAPH_API_URL + "192837465/photos"))
			.andExpect(method(POST))
			.andExpect(header("Authorization", "OAuth someAccessToken"))
			.andRespond(withSuccess("{\"id\":\"12345\"}", MediaType.APPLICATION_JSON));
		// TODO: Match body content to ensure fields and photo are included
	...
	public void getVideos() {
		mockServer.expect(requestTo(GraphApi.GRAPH_API_URL + "me/videos?offset=0&limit=25"))
			.andExpect(method(GET))
			.andExpect(header("Authorization", "OAuth someAccessToken"))
	...
	public void getVideos_forSpecificOwner() {
		mockServer.expect(requestTo(GraphApi.GRAPH_API_URL + "100001387295207/videos?offset=0&limit=25"))
			.andExpect(method(GET))
			.andExpect(header("Authorization", "OAuth someAccessToken"))
			.andRespond(withSuccess(jsonResource("videos"), MediaType.APPLICATION_JSON));
	...
	public void getVideo_preOctober2012() {
		mockServer.expect(requestTo(GraphApi.GRAPH_API_URL + "161500020572907"))
			.andExpect(method(GET))
			.andExpect(header("Authorization", "OAuth someAccessToken"))
